...
export default function Knacks() {
  return (
    <div className='pt-6 px-20 flex items-stretch gap-16 justify-center flex-wrap '>
      ...
      <Preview photo="/images/img5.png" username="another1" description="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat." price="25"/>
    </div>
  );
}
