...
const Listing = ({ author, image, description, price, postedAt, className, ...props }) => {
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="flex items-baseline gap-4 border-b px-2 py-2">
        <span className="grow text-sm font-medium">{author}</span>
      ...
      <div className="flex items-baseline gap-4 border-t px-2 py-2">
        <span className="grow truncate text-sm">{description}</span>
